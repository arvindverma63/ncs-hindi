<x-coach-layout title="Edit Blog: {{ $blog->title }}">
    @push('css')
    ...
    <div class="content-wrapper px-2 mt-10">
        <form action="{{ route('coach.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data"
            id="blogForm">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-bottom py-2">
                            <h6 class="card-title mb-0 fs-14 fw-bold text-muted">SEO Metadata</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div class="sticky-publish">
                        <div class="card border-0 shadow-sm mb-3">
                            <div class="card-header bg-white border-bottom">
                                <h6 class="card-title mb-0 fw-bold fs-14">Publishing Actions</h6>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm w-100 fw-bold">
                                    <iconify-icon icon="tabler:device-floppy" class="me-1 align-middle"></iconify-icon>
                                    Update Blog
                                </button>
                                <a href="{{ route('coach.blogs.index') }}"
                                    class="btn btn-link btn-sm w-100 mt-2 text-muted">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
